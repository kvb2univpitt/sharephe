 ...
 * MA 02110-1301  USA
 */
package edu.pitt.dbmi.i2b2.sharephe.pm;
...
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.RequestHeaderType;
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.RequestMessageType;
import edu.pitt.dbmi.i2b2.sharephe.datavo.pm.GetUserConfigurationType;
...
public class GetUserConfigurationRequestMessage extends ProjectManagementRequestData {
    ...
    public String getXMLString(RequestMessageType reqMessageType) throws JAXBUtilException {
        try (StringWriter writer = new StringWriter()) {
            JAXBElement<RequestMessageType> element = (new edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.ObjectFactory())
                    .createRequest(reqMessageType);
            SharepheJAXBUtil.getJaxbUtil().marshaller(element, writer);
    ...
    public BodyType getBodyType(GetUserConfigurationType userConfigurationType) {
        JAXBElement<GetUserConfigurationType> element = (new edu.pitt.dbmi.i2b2.sharephe.datavo.pm.ObjectFactory())
