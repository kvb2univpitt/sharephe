...
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.ApplicationType;
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.BodyType;
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.FacilityType;
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.MessageControlIdType;
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.MessageHeaderType;
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.ProcessingIdType;
import edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.ResponseHeaderType;
...
public class MessageFactory {
    ...
    public static String convertToXMLString(ResponseMessageType respMessageType) throws I2B2Exception {
        try (StringWriter writer = new StringWriter()) {
            edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.ObjectFactory objectFactory = new edu.pitt.dbmi.i2b2.sharephe.datavo.i2b2message.ObjectFactory();
            SharepheJAXBUtil.getJaxbUtil().marshaller(objectFactory.createResponse(respMessageType), writer);
    ...
    public static MessageHeaderType createResponseMessageHeader(MessageHeaderType reqMsgHeader) {
        ...
        appType.setApplicationName("Sharephe Cell");
    ...
    public static ResponseMessageType buildGetSharepheWorkbookResponse(MessageHeaderType messageHeaderType, SharepheWorkbooksType value) {
    ...
    public static ResponseMessageType buildAddWorkbookResponse(MessageHeaderType messageHeaderType, SharepheWorkbookType value) {
        ResponseHeaderType respHeader = createResponseHeader("DONE", "Sharephe processing completed");

        BodyType bodyType = new BodyType();
        if (value != null) {
            edu.pitt.dbmi.i2b2.sharephe.datavo.vdo.ObjectFactory of = new edu.pitt.dbmi.i2b2.sharephe.datavo.vdo.ObjectFactory();
            bodyType.getAny().add(of.createSharepheWorkbook(value));
        }
